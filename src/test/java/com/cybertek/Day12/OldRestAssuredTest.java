...
public class OldRestAssuredTest extends SpartanNewBase {
    ...
    public void getAllSpartan(){
        given()
                ...
                .body("id[0]",is(10))              //hard assertion, if first case fails second will not be executed
                .body("id[5]",is(199))
                .log().all();
    ...
    public void test2(){
        ...
        given()
                ...
                .body("id[0]",is(10))             //soft assertion ->if first one fails,second one will run as well
                .body("id[5]",is(199))
