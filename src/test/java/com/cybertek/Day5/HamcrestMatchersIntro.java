...
public class HamcrestMatchersIntro {
    ...
    public void simpleTest(){
        ...
        //below examples is method is accepting another matches equal to make it readable
        assertThat(5+5,is(equalTo(10)));

        assertThat(5+5,not(4));
        assertThat(5+5,is(not(9)));
        assertThat(5+5,is(not(equalTo(6))));
    ...
    public void testCollection(){
        List<Integer> listOfNumbers= Arrays.asList(1,2,3,4,56,6,4,3,2,2,2);
        //check size of the list
        assertThat(listOfNumbers,hasSize(11));
        //check if this list hasItem77
        assertThat(listOfNumbers,hasItem(56));
        //check if this list hasItem 6,56,3
        assertThat(listOfNumbers,hasItems(56,3,2));
